...
{
	$to = 'info@angelcosmoceuticals.com';
	...
	$message .= '<h2 style="background-color: #eeeeee;">New Form Submission from <a href="http://angelcosmoceuticals.com/index.html#contact">angelcosmoceuticals.com</a></h2><table cellspacing="0" cellpadding="0" width="100%" style="background-color: #ffffff;">'; 
